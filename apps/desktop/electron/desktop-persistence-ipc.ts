...
let storage: DesktopSqliteStore | undefined;
let credentials: SafeStorageCredentialStore | undefined;
let iptvRuntime: DesktopIptvRuntime | undefined;
let playback: DesktopPlaybackTransport | undefined;
