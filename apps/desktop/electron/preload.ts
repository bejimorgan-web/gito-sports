...
import type { DesktopCredentialApi, DesktopIptvRuntimeApi, DesktopPlaybackApi, DesktopStorageApi } from "../src/desktop-persistence-contract.js";

const desktopStorage: DesktopStorageApi = {
  providerAccounts: {
...
const desktopCredentials: DesktopCredentialApi = {
...
const desktopIptv: DesktopIptvRuntimeApi = {
...
const desktopPlayback: DesktopPlaybackApi = {
