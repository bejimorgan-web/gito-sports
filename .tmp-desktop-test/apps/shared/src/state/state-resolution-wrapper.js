 ...
 */
export function resolveEventState(key, value, source, eventId) {
 ...
 */
function generateBlockReason(requestedSource, currentSource, key) {
    if (!currentSource) {
 ...
 */
export function resolveEventStateBatch(updates) {
 ...
 */
export function validateStateSource(source) {
