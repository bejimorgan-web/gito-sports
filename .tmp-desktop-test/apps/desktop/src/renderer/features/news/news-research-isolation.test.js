...
function initializeDom() {
    ...
    Object.defineProperty(globalAny, "requestAnimationFrame", {
        value: typeof win.requestAnimationFrame === "function" ? win.requestAnimationFrame.bind(win) : (callback) => setTimeout(callback, 0),
        writable: true,
        configurable: true,
        enumerable: true
    });
    Object.defineProperty(globalAny, "cancelAnimationFrame", {
        value: typeof win.cancelAnimationFrame === "function" ? win.cancelAnimationFrame.bind(win) : (handle) => clearTimeout(handle),
        writable: true,
        configurable: true,
        enumerable: true
    });
...
function buildFetchMock() {
    ...
    const createJsonResponse = (body, status = 200) => new Response(JSON.stringify(body), { status, headers: { "content-type": "application/json" } });
