...
test("canonical fixture lineup editor exposes independent home and away workflows", () => {
    const markup = renderToStaticMarkup(_jsx(FixtureLineupEditor, { accessToken: "token", fixture: { id: "fixture-1", seasonId: "season-1", sport: { id: "sport-1" }, homeTeam: { id: "home", name: "Home FC" }, awayTeam: { id: "away", name: "Away FC" } } }));
